...
const PAGES = new Set(['/marina/', '/marina', '/marina/brief-2204ff716968baaf/', '/marina/brief-2204ff716968baaf', '/marina/quote/', '/marina/quote', '/goom/v1/', '/goom/v1', '/sj/v1/', '/sj/v1', '/ecolove/v1/', '/ecolove/v1', '/danon/v1/', '/danon/v1', '/shlomit/v1/', '/shlomit/v1', '/magnolia/v1/', '/magnolia/v1']);
