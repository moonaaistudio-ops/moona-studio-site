...
(() => {
  ...
  const messages = {
    en: {
      ...
      'film.credit.copy': 'DUSTLINE · born without a camera',
      'film.credit.aiTerm': '',
      'film.credit.end': '',
      ...
      'film.beat.experience.mediaLabel': 'DUSTLINE desert-festival world with its stage, crowd and measured spatial guides.',
    ...
    he: {
      ...
      'film.credit.copy': 'כל האלמנטים נוצרו ללא אולפן וללא מצלמה. הם',
      'film.credit.aiTerm': '100% AI',
      'film.credit.end': '.',
      ...
      'film.beat.experience.mediaLabel': 'עולם הפסטיבל המדברי של DUSTLINE, עם הבמה, הקהל וסימוני מידות שממחישים את בניית הלוקיישן.',
      ...
      'studio.title.lead': 'אנחנו מעדיפים ',
      'studio.title.emphasis': 'להראות',
      'studio.title.tail': ' במקום לספר.',
      'studio.note': 'ללא התחייבות',
      'studio.statement.afterBrand': 'הוא סטודיו',
      'studio.statement.afterAi': 'שיוצר סרטי מותג ופרסומות ברמה קולנועית,',
      'studio.statement.emphasis': 'גם בלי מצלמה.',

      'contact.line': 'עכשיו תורך.',
      'contact.or': 'או',
