...
(() => {
  ...
  const messages = {
    en: {
      ...
      'hero.eyebrow': 'Founder-led · Tel Aviv',
      'hero.headline.lead': 'Creative technology.',
      'hero.headline.aiTerm': '',
      'hero.headline.emphasis': 'Directed.',
      'hero.subline.one': 'Film · Software · AI systems',
      'hero.subline.two': '',
      'hero.cta': 'Start a project',
      'hero.workCta': 'View work',
    ...
    he: {
      ...
      'hero.eyebrow': 'בהובלת המייסד · תל אביב',
      'hero.headline.lead': 'קריאייטיב טכנולוגי.',
      'hero.headline.aiTerm': '',
      'hero.headline.emphasis': 'תחת בימוי.',
      'hero.subline.one': 'סרטים · תוכנה · מערכות AI',
      'hero.subline.two': '',
      'hero.cta': 'מתחילים פרויקט',
      'hero.workCta': 'לעבודות',
