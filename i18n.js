...
(() => {
  ...
  const messages = {
    en: {
      ...
      'consent.text': 'Allow site analytics?',
      ...
      'privacy.intro': 'Moona Studio measures how the site is used to improve our work. PostHog runs on every page without cookies. Google Analytics and Microsoft Clarity load only if you choose “Yes” in the analytics notice. You can choose “No” instead.',
    ...
    he: {
      ...
      'consent.text': 'לאשר מדידה לשיפור האתר?',
      'consent.privacy': 'פרטיות',
      'consent.accept': 'כן',
      'consent.decline': 'לא',
      ...
      'privacy.intro': 'ב־Moona Studio אנחנו מודדים איך משתמשים באתר כדי לשפר את העבודה שלנו. שירות PostHog פועל בכל העמודים בלי עוגיות. Google Analytics ו־Microsoft Clarity נטענים רק אם בוחרים ״כן״ בחלונית המדידה באתר. אפשר לבחור במקום זאת ב״לא״.',
