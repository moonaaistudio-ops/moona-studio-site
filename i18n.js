...
(() => {
  ...
  const messages = {
    en: {
      ...
      "solutions.visuals.body": "Product imagery, characters and cinematic worlds built with AI. A consistent visual language connects the stills, the shots and the campaign.",
      ...
      'contact.body': 'Send the brand and a rough note on what you want made. We reply within two business days.',
      'contact.or': 'or',
    ...
    he: {
      ...
      "solutions.visuals.body": "תמונות מוצר, דמויות ועולמות קולנועיים שנבנים עם AI. שפה חזותית עקבית מחברת בין התמונות, השוטים והקמפיין.",
      ...
      'contact.body': 'שלחו את המותג וכמה מילים על מה שאתם רוצים שנעשה. נחזור אליכם בתוך שני ימי עסקים.',
      'contact.or': 'או',
