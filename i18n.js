...
(() => {
  ...
  const messages = {
    en: {
      ...
      'film.beat.viewer.label': 'The viewer',
      'film.beat.viewer.title': 'Built for how people actually watch.',
      'film.beat.viewer.body': 'It has to land on mute, on a phone, in one pass. Every clue sits on screen the whole time, so the second viewing pays and the first stays clean. We watch it silent before anyone else does.',
    ...
    he: {
      ...
      'meta.home.description': 'אנחנו בונים את העולם, ואז מצלמים את הפרסומת. סטודיו AI-native שיוצר סרטי מותג קולנועיים במלאכת מחשבת חסרת פשרות.',
      ...
      'consent.label': 'העדפות אנליטיקה',
      'consent.text': 'אנחנו משתמשים באנליטיקה כדי להבין את ביצועי האתר.',
      'consent.privacy': 'הודעת פרטיות',
      'consent.accept': 'אישור אנליטיקה',
      'consent.decline': 'דחיית אנליטיקה',
      ...
      'hero.subline.one': 'סטודיו AI-native לקולנוע ולפרסומות בתנועה.',
      'hero.subline.two': 'הסיפור, המלאכה והטעם קודמים לכל.',
      'hero.cta': 'יצירת פרסומת למותג',
      'hero.turn.setup': 'אנחנו לא מצלמים מוצרים.',
      'hero.turn.payoff': 'אנחנו מצלמים את המשמעות שלהם.',
      'hero.scroll': 'לגלול',
      ...
      'film.how.eyebrow': 'איך אנחנו עובדים',
      'film.how.body': 'שום דבר כאן לא הושאר למודל. ימים של טייקים חוזרים, וכל פריים הוכרע, נמדד ועבר גריידינג עוד לפני שנוצר. אנחנו פועלים בחזית הכלים האלה — וזה חשוב רק מפני שההחלטות התקבלו קודם בידי אדם.',
      'film.beat.experience.label': 'החוויה',
      'film.beat.experience.title': 'אנחנו לא מחפשים לוקיישנים. אנחנו בונים חוויה.',
      'film.beat.experience.body': 'עולם שאפשר להאמין בו, ואז למדוד עד המטר: המרווח בין האבנים הוא 0.90 מ׳, המגדלים בגובה 21 מ׳, והשמיים והקרקע נבנו צבע אחר צבע. טעות במקום הופכת כל שוט שמתרחש בו לטעות.',
      'film.beat.shots.label': 'השוטים',
      'film.beat.shots.title': 'המקצוענות נמצאת בפרטים.',
      'film.beat.shots.body': 'פריים קפוא באופן מתמטי הוא הסימן הברור ביותר ששוט נוצר ב־AI. כל מצלמה כאן נושמת, נושאת צעד, נסחפת — ולעולם לא זזה בלי סיבה בתוך הסיפור. לא מבחינים בזה. מרגישים את זה.',
      'film.beat.cast.label': 'הקאסט',
      'film.beat.cast.title': 'הרפרנס קודם לתסריט.',
      'film.beat.cast.body': 'פנים, לבוש ואריזה ננעלים על תמונות מאושרות לפני שנוצר פריים. כשהטקסט סותר את הרפרנס, הטקסט משתנה. סטייה בין שוטים היא הכשל הראשון שאנחנו מתכננים למנוע.',
      'film.beat.viewer.label': 'הצפייה',
      'film.beat.viewer.title': 'נבנה לאופן שבו באמת צופים.',
      'film.beat.viewer.body': 'זה חייב לעבוד בלי קול, בטלפון ובצפייה אחת. כל רמז נשאר על המסך לאורך כל הסרט, כך שהצפייה השנייה מתגמלת והראשונה נשארת נקייה. אנחנו צופים בלי קול לפני כולם.',

      'work.eyebrow': 'עבודות Spec · אף אחד לא ביקש אותן',
      'work.note': 'ארבעה מותגים שאינם לקוחות שלנו. יצרנו את הסרטים האלה בכל זאת — בדיוק כפי שניצור גם עבור המותג הבא.',
      'work.specBadge': 'יצירה מקורית של Moona · Spec',
      'work.mcdonalds.video': "סרט Spec ביוזמת Moona עבור McDonald's",
      ...
      'privacy.intro': 'ב־Moona Studio נעשה שימוש באנליטיקה אופציונלית כדי להבין את השימוש באתר ולשפר את עבודתנו. שירותי האנליטיקה אינם נטענים עד לבחירה ב״אישור אנליטיקה״ בהודעה שבאתר. אפשר לבחור במקום זאת ב״דחיית אנליטיקה״.',
      ...
      'privacy.choices.body': 'אפשר לסרב לאנליטיקה בהודעה שבאתר. אם ניתנה בעבר הסכמה, אפשר למחוק את נתוני האתר השמורים בדפדפן ולטעון מחדש כדי לבחור שוב. אנחנו מכבדים, כשהם זמינים, מנגנוני פרטיות בדפדפן כגון Do Not Track ו־Global Privacy Control.',
