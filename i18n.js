...
(() => {
  ...
  const messages = {
    en: {
      ...
      'hero.subline.one': 'Direction · Software development · AI production',
      'hero.subline.two': '',
      'hero.cta': 'Start a project',
      'hero.workCta': 'Work',
      'hero.projectCta': 'Contact',
      'hero.projectCtaLabel': 'Contact Moona about a project',
      'hero.scroll': 'Scroll',
    ...
    he: {
      ...
      'hero.headline.aiTerm': '',
      'hero.headline.emphasis': '',
      'hero.subline.one': 'בימוי · פיתוח תוכנה · הפקת AI',
      'hero.subline.two': '',
      'hero.cta': 'מתחילים פרויקט',
      'hero.workCta': 'עבודות',
      'hero.projectCta': 'פנייה',
      'hero.projectCtaLabel': 'פנייה ל־Moona לגבי פרויקט',
      'hero.scroll': 'לגלול',
