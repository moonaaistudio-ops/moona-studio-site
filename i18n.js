...
(() => {
  ...
  const messages = {
    en: {
      ...
      'crew.intro': 'Specialists across story, image, film, sound and systems.',
      ...
      'crew.vero.role': 'Editorial',
      'crew.vero.line': 'Cuts until every beat feels inevitable.',
      'crew.sona.role': 'Sound & Voice',
      'crew.sona.line': 'Hears the film before the first cut.',
      'crew.iva.role': 'Production Systems',
      'crew.iva.line': 'Keeps the technology invisible and the work moving.',
    ...
    he: {
      ...
      'crew.transition': 'צוות של סוכני AI מתמחים. כולם נבנו בסטודיו.',
      ...
      'crew.intro': 'מומחים לסיפור, תמונה, קולנוע, סאונד ומערכות.',
      ...
      'crew.vero.line': 'חותך עד שכל ביט מרגיש בלתי נמנע.',
      'crew.sona.role': 'סאונד וקול',
      'crew.sona.line': 'שומעת את הסרט לפני הקאט הראשון.',
      'crew.iva.role': 'מערכות הפקה',
      'crew.iva.line': 'שומרת שהטכנולוגיה תישאר בלתי נראית והעבודה תמשיך לנוע.',
