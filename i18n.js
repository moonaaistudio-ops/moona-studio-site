...
(() => {
  ...
  const messages = {
    en: {
      ...
      'hero.eyebrow': 'Founder-led creative technology studio',
      'hero.headline.lead': 'MOONA',
      'hero.headline.aiTerm': '',
      'hero.headline.emphasis': '',
      'hero.subline.one': 'Cinematic campaigns, built differently',
      'hero.subline.two': '',
      'hero.cta': 'Start a project',
      'hero.workCta': 'Work',
      'hero.projectCta': 'Project',
      'hero.projectCtaLabel': 'Start a project',
      'hero.scroll': 'Scroll',
      ...
      'crew.previous': 'Previous crew members',
      'crew.next': 'Next crew members',
    ...
    he: {
      ...
      'hero.eyebrow': 'סטודיו קריאייטיב טכנולוגי בהובלת המייסד',
      'hero.headline.lead': 'MOONA',
      'hero.headline.aiTerm': '',
      'hero.headline.emphasis': '',
      'hero.subline.one': 'קמפיינים קולנועיים, שנבנו אחרת',
      'hero.subline.two': '',
      'hero.cta': 'מתחילים פרויקט',
      'hero.workCta': 'עבודות',
      'hero.projectCta': 'פרויקט',
      'hero.projectCtaLabel': 'מתחילים פרויקט',
      'hero.scroll': 'לגלול',
      ...
      'crew.previous': 'חברי הצוות הקודמים',
      'crew.next': 'חברי הצוות הבאים',
