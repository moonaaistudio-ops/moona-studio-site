...
(() => {
  ...
  const messages = {
    en: {
      ...
      "form.product.dialog": "One product",
      "form.product.title": "Start with one product.",
      "form.product.intro": "Send a link to one product. We reply with a direction within two business days.",
      "form.product.link": "Product link (optional)",
      "form.product.linkPlaceholder": "yourbrand.com/product",
      "form.product.brief": "Anything we should know? (optional)",
      "form.product.placeholder": "For example, the launch date or where the film will run.",
      "form.product.done": "We will look at the product and reply with a direction within two business days.",
      ...
      'consent.text': 'Can we use analytics to improve this site?',
      ...
      'work.bullPadel.replay': 'Watch again ↗',
      ...
      'privacy.intro': 'Moona Studio measures how the site is used to improve our work. PostHog runs on every page without cookies. Google Analytics and Microsoft Clarity load only if you choose “Yes” in the analytics notice. You can choose “No, thanks” instead.',
    ...
    he: {
      ...
      "form.product.dialog": "מוצר אחד",
      "form.product.title": "מתחילים ממוצר אחד.",
      "form.product.intro": "שלחו לינק למוצר אחד. נחזור אליכם עם כיוון בתוך שני ימי עסקים.",
      "form.product.link": "לינק למוצר (לא חובה)",
      "form.product.linkPlaceholder": "yourbrand.com/product",
      "form.product.brief": "משהו שחשוב שנדע? (לא חובה)",
      "form.product.placeholder": "למשל, מועד ההשקה או איפה הסרט ירוץ.",
      "form.product.done": "נעבור על המוצר ונחזור אליכם עם כיוון בתוך שני ימי עסקים.",
      ...
      'consent.label': 'בחירה לגבי מדידה באתר',
      'consent.text': 'אפשר להשתמש בכלי מדידה כדי לשפר את האתר?',
      ...
      'work.bullPadel.replay': 'לצפות שוב ↗',
      ...
      'privacy.intro': 'ב־Moona Studio אנחנו מודדים איך משתמשים באתר כדי לשפר את העבודה שלנו. שירות PostHog פועל בכל העמודים בלי עוגיות. Google Analytics ו־Microsoft Clarity נטענים רק אם בוחרים ״כן״ בחלונית המדידה באתר. אפשר לבחור במקום זאת ב״לא, תודה״.',
